...
class UpdateCustomersComponent extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        CustomersService.getCustomersById(this.state.id).then((res) => {
            let customers = { postal_code: this.state.postal_code, company_name: this.state.company_name, contact_name: this.state.contact_name, contact_title: this.state.contact_title, address: this.state.address, country: this.state.country, city: this.state.city, phone: this.state.phone, fax: this.state.fax };
            this.setState({
                        ...
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.updateCustomers} style={{ marginLeft: "10px" }}>Save</button>
...
export default UpdateCustomersComponent;